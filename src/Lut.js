...
class Lut {
	...
	getColor(alpha) {
		...
		colorPosition == this.n ? colorPosition -= 1 : colorPosition = colorPosition;
...
const ColorMapKeywords = {
	...
	'rainbow': [[0.0, 0x9FBDFF], [0.2, 0xFFC0CB], [0.5, 0xFF69B4], [0.8, 0xEE0000], [1.0, 0xFF0000]],
	'cooltowarm': [[0.0, 0x3C4EC2], [0.2, 0x9BBCFF], [0.5, 0xDCDCDC], [0.8, 0xF6A385], [1.0, 0xB40426]],
	'blackbody': [[0.0, 0x000000], [0.2, 0x780000], [0.5, 0xE63200], [0.8, 0xFFFF00], [1.0, 0xFFFFFF]],
	'grayscale': [[0.0, 0x000000], [0.2, 0x404040], [0.5, 0x7F7F80], [0.8, 0xBFBFBF], [1.0, 0xFFFFFF]],
	'decisionpath': [[0.0, 0xAAAAAA], [0.2, 0x888888], [0.5, 0x666666], [0.8, 0x444444], [1.0, 0x000000]]
